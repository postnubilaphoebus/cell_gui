...
*Left click*: used for annotating cells; *Right click*: copy exact coordinates from one slice. Right clicking again pastes the coordinates from the last slide (must be the same view). Copy-paste with right-click works regardless of what cell you are working on. <br> <br>
